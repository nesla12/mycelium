...
A child learns when an adult guides their mental effort toward a clear goal, at a level of difficulty that is hard but achievable. Everything else is detail.

The form of that guidance changes as the child's knowledge grows. For a young child it looks like guided play. For a school-age child building new skills it looks like explicit teaching followed by practice. For an older child with real knowledge it looks like projects, inquiry, and teaching others. These are not competing philosophies. They are the same principle at three stages.

Two things follow, and they hold at every age:

1. **Knowledge comes before skill.** You cannot think critically, solve problems, or be creative in a vacuum. These abilities run on a deep base of factual knowledge held in long-term memory. A "thinking skills" program with no content to think about does not work. Build the knowledge first, and the thinking becomes possible.

2. **Learning is the residue of thinking.** A child remembers what they actively think about, not what passes in front of them. The best test of any activity, lesson, app, or AI tool is one question: who is doing the thinking? If the child is, it teaches. If the tool, the screen, or the adult is, it does not.
...
**Protect working memory.** A child can only hold a few new things in mind at once. Teach in small steps, remove clutter and distraction, and let the basics become automatic so attention is freed for harder thinking. A fact recalled effortlessly is a fact that no longer costs mental space.

**Aim for desirable difficulty.** Too easy is boring, too hard is defeating. The sweet spot is effortful success. This is where curiosity lives and where the satisfaction that drives more learning comes from.
...
None of the above works on a tired, sedentary, unspoken-to child. These are preconditions, not extras.
...
**Talk and connection.** The single cheapest, most powerful intervention at every age is a present adult who talks with the child and listens.

**Nature and boredom.** Time outdoors and even ordinary boredom give attention a chance to recover and imagination a chance to start.
...
- **Are they reading fluently and widely?** For young readers, listen to them read aloud. Halting decoding means more phonics, not more pressure.
- **Look at the work over time.** A folder of a child's actual writing or problem-solving across months tells you more than any single score.
- **Is the difficulty right?** If everything is easy, raise it. If everything is a struggle, the steps are too big. Aim for effortful success.

---

## What this is not, and its limits

This is a methods and curriculum guide, not a school in a box and not a guarantee. Honesty about the evidence matters:

- Effect sizes in education are usually modest, and context, culture, and the individual child all matter.
